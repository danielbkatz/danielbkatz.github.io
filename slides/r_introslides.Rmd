...
.pull-left[+ A path to a Word doc on my desktop looks like: "C:/Users/katzd/Desktop/myfile.docx".
...
.pull-right[+ Instead, we'll tell `R` where to read files from, where to export, etc, via `projects`
...
+ If I have a folder called, `analysis` in `thesis`, and thesis is my working directory the path will be "analysis/filename.ext".
