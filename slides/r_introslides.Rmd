...
mean(x)
```
+ In R speak, the particular thing that goes in the parentheses of a function, such as `mean` is called an <mark>argument</mark>

+ R functions often take more than one argument

+ Because of <mark>code completion</mark>, you can see what arguments a function takes as you start typing]
---
