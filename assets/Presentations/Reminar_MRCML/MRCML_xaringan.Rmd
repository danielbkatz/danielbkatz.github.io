...
The outcome is defined as being drawn from a Bernoulli (or Binomial): [Click Here for my Derivation]({{ site.url }}{% link assets/Presentations/Reminar_MRCML/linkfun.pdf %})
