...
+ I want the item difficulty of the item "adjusting for" the item type effect (this is relevant to differential bundle functioning as well)
...
CDM::IRT.compareModels(test_run, mod_l)$IC
```
...
+ In this model, the item category, or item step difficulties are allowed to differ across items 
...
+ Random Item or Random Item covariate models can be run in `lme4`
