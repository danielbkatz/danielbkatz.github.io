...
2. Introduction to an example reading test that motivated this presentation

3. Explaining DIF and considering the construct of interest - group membership and construct "representation"

4. Presenting an iterative workflow - between theoretical considerations and (statistical) modeling
...
+ My interests are centered around different concepts of uncertainty in measurement 
  + Beyond parameter estimates
  + Don't align with "true vs estimated"
  

+ I'm especially interested in the concept of "definitional uncertainty" - e.g. the measurand, the property
...
+ The thing our words or symbols or "factor name" might represetnt or refer (signified)

+ The thing we use to refer to those things - the label - the signifier

+ Thinking this way helps us figure out what it is to be these things 

+ Sometimes it's easy to get these confused
...
+ But always, language is never going to be quiiiite enough. 
...
+ NAEP has a report card for reading and literacy in the United States

+ What are people to take these stakeholders to make of scores interpretation
